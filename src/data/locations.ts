...
export const emirates: Emirate[] = [
  {
    ...
    cities: [
      ...
      { name: "JBR", slug: "jbr", emirateSlug: "dubai", image: "/images/areas/dubai/jbr.webp", description: "Serving the Jumeirah Beach Residence community with reliable apartment cleaning. Our teams handle everything from studios to spacious family units in this popular beachfront destination.", metaTitle: "Cleaning Services in JBR, Dubai", metaDescription: "Apartment cleaning in JBR, Dubai. Reliable service for Jumeirah Beach Residence community." },
      { name: "Silicon Oasis", slug: "silicon-oasis", emirateSlug: "dubai", image: "/images/areas/dubai/silicon-oasis.webp", description: "Affordable, high-quality cleaning for Silicon Oasis residents. We clean apartments and townhouses in this family-friendly community, offering flexible packages to fit every budget.", metaTitle: "Cleaning Services in Silicon Oasis, Dubai", metaDescription: "Affordable cleaning services in Dubai Silicon Oasis. Apartments and townhouses cleaned professionally." },
    ],
  },
  {
    name: "Abu Dhabi",
  ...
  },
  {
    ...
    heroImage: "/images/heroes/sharjah-hero.webp",
  ...
  },
  {
    ...
    image: "/images/locations/ras-al-khaimah.webp",
